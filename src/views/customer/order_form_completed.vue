...
import {getcompletedorderList,orderstateSubmit} from '@/service/genServ.js'
export default {
  name: 'order_form',
  data() {
    return {
  ...
  methods: {
    doQuery() {
      ...
      getcompletedorderList({'usernum':localStorage.getItem('usernum'),'date':d,'orderstate':"已完成"}).then(res => {
